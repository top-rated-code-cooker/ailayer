...
<div style={{opacity: 1, transform: 'translateY(0px) translateZ(0px)'}} >
    <div className="mt-10 relative">
        <div className="bg-[#030515]/40 text-primary/50 relative text-xl lg:text-2xl font-semibold" role="tablist" aria-orientation="horizontal">
            <button className="outline-none py-4 pr-4 hl-selected:text-white hover:text-white" id="headlessui-tabs-tab-:r2:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r4:">
    ...
    <span 
        ...
        ></span>
        <div id="headlessui-tabs-panel-:r5:" role="tabpanel" aria-labelledby="headlessui-tabs-tab-:r3:" tabindex="0" data-headlessui-state="selected">
