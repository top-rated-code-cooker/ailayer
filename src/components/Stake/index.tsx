...
function Stake(){
    const [selectedAssets, setSelectedAssets] = useState("personal");
    ...
    return(
            <div className="pt-[120px] g-container main-div relative">
                <>
                            ...
                            <div className="bg-[#030515]/40 text-primary/50 relative text-xl lg:text-2xl font-semibold" role="tablist" aria-orientation="horizontal">
                                {
                                    ...
                                    :
                                    <button className="outline-none py-4 pr-4 hl-selected:text-white hover:text-white" id="headlessui-tabs-tab-:r2:" role="tab" type="button" aria-selected="false" data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r4:" onClick={()=>setSelectedAssets("personal")}>
                                    <div className="flex flex-col justify-between gap-1"><span>Your Assets</span>
                                ...
                                :
                                    ...
                                    data-headlessui-state="selected"
                                    aria-controls="headlessui-tabs-panel-:r5:"
                                    onClick={()=>setSelectedAssets("team")}
                                    >
                                        <div className="flex flex-col justify-between gap-1">
                                            <span>Team Assets</span>
